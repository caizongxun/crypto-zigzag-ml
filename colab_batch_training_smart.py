...
Usage in Colab:
1. exec(open('colab_batch_training_smart.py').read())
"""
...
if not models_to_train:
    print('='*70)
    print('All 44 models already trained!')
    print('='*70)
    sys.exit(0)
...
for idx, (symbol, timeframe) in enumerate(models_to_train, 1):
    ...
    print(f'[{total_progress:2d}/44] {symbol:10s} {timeframe}... ', end='', flush=True)
...
print(f'Overall progress: {len(already_trained) + len(successful)}/44')
